export const COUNTRY_STATES: Record<string, string[]> = {
  ...
  "Sri Lanka": ["Western", "Central", "Southern", "Northern", "Eastern", "North Western", "Sabaragamuwa", "Colombo", "Kandy", "Galle", "Jaffna", "Negombo"],
  ...
  Thailand: ["Bangk ok", "Nonthaburi", "Nakhon Ratchasima", "Chiang Mai", "Hat Yai"],
