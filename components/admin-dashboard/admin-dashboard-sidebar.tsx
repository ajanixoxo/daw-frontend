...
const navItems = [
  ...
  { icon: ShoppingBag, label: "User", href: "/admin-dashboard/user" },
  ...
  { icon: HandCoins, label: "Cooperative", href: "/admin-dashboard/cooperative" },
  { icon: Wallet, label: "Listings", href: "/admin-dashboard/listings" },
