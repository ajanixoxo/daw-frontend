...
const navItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "/sellers-dashboard/dashboard" },
  { icon: ShoppingBag, label: "Shop", href: "/sellers-dashboard/shop" },
  { icon: Package, label: "Products", href: "/sellers-dashboard/products" },
  { icon: ShoppingCart, label: "Orders", href: "/sellers-dashboard/orders" },
  { icon: HandCoins, label: "Contribution", href: "/sellers-dashboard/contribution" },
  { icon: Wallet, label: "Loans", href: "/sellers-dashboard/loans" },
  { icon: BarChart3, label: "Analytics", href: "/sellers-dashboard/analytics" },
  { icon: Settings, label: "Settings", href: "/sellers-dashboard/settings" },
]
