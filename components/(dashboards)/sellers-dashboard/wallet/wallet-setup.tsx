            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-5/12 bg-linear-to-br from-[#1d1d2a] to-[#2d2d3d] p-8 text-white flex flex-col justify-between">
                    <div>
                        ...
                        <h2 className="text-2xl font-bold mb-4">Seller Wallet</h2>
                        <p className="text-gray-400 text-sm leading-relaxed mb-8">
                            Create your secure virtual account to access all financial features.
                        </p>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="text-xs">
                                    ...
                                    <p className="text-gray-400 mt-1">Receive payments from customers instantly.</p>
                                </div>
                            </div>
                        </div>
                    </div>
