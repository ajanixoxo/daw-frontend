...
export function WithdrawFundsDrawer({
  ...
  const fetchBanks = async () => {
    console.log("Client: Fetching banks starting...");
    setBanksLoading(true);
    try {
      const result = await getBanks();
      console.log("Client: Banks result received:", result);
      ...
      console.error("Client: Banks fetch error:", error);
  ...
  const handleLookup = async () => {
    ...
    console.log("Client: Starting account lookup for", formData.accountNumber, "Bank:", formData.bankCode);
    setLookupLoading(true);
    try {
      const result = await accountLookup(formData.bankCode, formData.accountNumber);
      console.log("Client: Lookup result received:", result);
      if (result.success && result.data) {
