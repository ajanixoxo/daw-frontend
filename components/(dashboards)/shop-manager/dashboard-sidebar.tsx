...
const navItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "/shop-manager/dashboard" },
  { icon: ShoppingBag, label: "Shop", href: "/shop-manager/shop" },
    { icon: HandCoins, label: "Contribution", href: "/shop-manager/contribution" },
