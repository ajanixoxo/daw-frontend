                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            ...
                            <p className="text-xs text-orange-600 font-bold mt-2.5 flex items-center gap-1">
                                <Skeleton className="h-1 w-8 rounded-full bg-orange-200" /> In Progress
                            </p>
                        </div>
                    </div>
                    <p className="text-[10px] font-bold text-[#667185]/40 mt-4 uppercase tracking-[0.2em]">PENDING SETTLEMENTS</p>
                </CardContent>
            </Card>
        </div>
    );
