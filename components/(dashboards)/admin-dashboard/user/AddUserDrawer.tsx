...
export function AddUserDrawer({ userId, mode = 'create', open: controlledOpen, onOpenChange, trigger }: AddUserDrawerProps) {
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {isLoadingUser && mode === 'edit' ? (
            ...
            <div className="space-y-6">
              ...
              {/* Additional Notes (Create mode only) */}
              {mode === 'create' && (
                <div className="space-y-2">
        ...
        <div className="p-6 border-t border-gray-100 bg-white/50 backdrop-blur-sm mt-auto">
          <Button
            ...
            disabled={isPending || (isLoadingUser && mode === 'edit')}
          >
            {isPending
