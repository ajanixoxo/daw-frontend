...
const navItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "/cooperative-dashboard/dashboard" },
  { icon: ShoppingBag, label: "Members", href: "/cooperative-dashboard/members" },
  ...
  { icon: HandCoins, label: "Contribution", href: "/cooperative-dashboard/contributions" },
  { icon: Wallet, label: "Loans", href: "/cooperative-dashboard/loans" },
  { icon: BarChart3, label: "Analytics", href: "/cooperative-dashboard/analytics" },
  { icon: Settings, label: "Settings", href: "/cooperative-dashboard/settings" },
]
