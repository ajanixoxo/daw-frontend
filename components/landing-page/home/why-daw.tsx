    ...
    <section className="w-full py-16 md:py-24 bg-[#ffeff7]">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <Link
            href="/sellers/kyc"
            className="bg-white rounded-2xl p-6 md:p-8 min-h-[280px] md:min-h-[320px] flex flex-col border-2 border-dashed border-[#d2d2d2] md:col-span-2 lg:col-span-1 hover:border-[#f10e7c] transition-colors cursor-pointer"
          >
            <div className="w-12 h-12 flex items-center justify-center mb-auto">
              <Monitor className="w-8 h-8 text-[#000000]" />
            </div>
