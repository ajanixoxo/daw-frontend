...
export function ProductDetails({ product }: ProductDetailsProps) {
  ...
  const [activeTab, setActiveTab] = useState<"descriptions" | "feedback">(
    "descriptions",
  );
  ...
  return (
    <section className="py-8 md:py-12 lg:py-24 px-4 md:px-8 lg:px-16 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12">
        ...
        <div>
          ...
          <p className="text-[#6b6b6b] text-sm leading-relaxed mb-6">
            {product.description}, per inceptos himenaeos. Nulla nibh diam,
            blandit vel consequat nec, ultrices et ipsum. Nulla varius magna a
            consequat pulvinar.
          </p>
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center border border-[#e5e5e5] rounded-full">
              ...
              <span className="w-10 text-center font-medium text-[#222222]">
                {quantity}
              </span>
              <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-[#6b6b6b] text-sm leading-relaxed mb-6">
                ...
                Sed lacus, metus faucibus elementum tincidunt, turpis mi viverra
              ...
              <p className="text-[#6b6b6b] text-sm leading-relaxed">
                ...
                Nulla blandit eros non turpis lobortis iaculis ut ut massa.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex">
                  <span className="w-28 text-[#6b6b6b] text-sm">
                    Stock Status:
                  </span>
                  <span className="text-[#222222] text-sm">
                    {product.stockStatus} (
        ...
        {activeTab === "feedback" && (
          <div className="text-center py-12">
            <p className="text-[#6b6b6b]">
              No customer feedback yet. Be the first to review this product!
            </p>
          </div>
        )}
      </div>
      ...
      {/* Related Products */}
      <div>
        <h2 className=" text-2xl md:text-3xl font-bold text-[#222222] text-center mb-8">
          Related Products
        </h2>
        ...
        <div className="text-center">
          <Link
            href="/marketplace"
            className="text-[#f10e7c] font-medium hover:underline"
          >
            Explore Marketplace
          </Link>
        </div>
