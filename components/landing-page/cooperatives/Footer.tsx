  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M22 12C22 6.48 17.52 2 12 2C6.48 2 2 6.48 2 12C2 16.84 5.44 20.87 10 21.8V15H8V12H10V9.5C10 7.57 11.57 6 13.5 6H16V9H14C13.45 9 13 9.45 13 10V12H16V15H13V21.95C18.05 21.45 22 17.19 22 12Z" fill="#6B6B6B"/>
        </svg>
      )
    },
    {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col gap-8 lg:col-span-1">
            ...
            <p className="text-[#6B6B6B] text-sm sm:text-base font-normal leading-[140%] tracking-[-0.64px]">
              Empowering African women entrepreneurs through digital commerce, education, and community.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex h-[60px] px-2 py-2 justify-between items-center rounded-[40px] border border-[#E5E5E5] bg-[#FFFFFF]">
              <input
                type="email"
                placeholder="Email address"
                className="flex-1 px-4 bg-transparent text-base font-medium tracking-[-0.64px] placeholder:text-[rgba(0,0,0,0.25)] outline-none"
              />
              <button className="flex px-4 py-3 justify-center items-center gap-1 rounded-[40px] bg-[#F10E7C] hover:bg-[#d00c69] transition-colors flex-shrink-0">
