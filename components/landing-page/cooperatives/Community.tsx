  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="w-full max-w-[1440px] py-16 sm:py-20 lg:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            ...
            <div className="flex flex-col gap-10">
              {/* Introduction Text */}
              <p className="text-[#A7A7A7] text-[15px] sm:text-[17px] leading-[1.6] max-w-[500px]">
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div
                    key={index}
                    className="p-6 rounded-[16px] bg-[#1A1A1A] border border-white/5 shadow-sm"
                  >
            ...
            <div className="flex flex-col justify-between h-full lg:min-h-[700px]">
              {/* Heading */}
              <h1 className="text-white text-[42px] sm:text-[54px] lg:text-[64px] font-bold leading-[1.1] tracking-tight text-balance">
              ...
              <div className="mt-20 lg:mt-auto self-start w-full sm:w-[420px] p-10 lg:p-12 rounded-[24px] bg-[#222222] flex flex-col items-center justify-center gap-2 border border-white/5 shadow-2xl">
      ...
      <section className="bg-white flex items-center justify-center px-4 sm:px-6 lg:px-24">
        <div className="w-full max-w-[1440px] py-20 lg:py-32">
          <div className="flex flex-col gap-16 lg:gap-24">
            {/* Header */}
            <div className="flex flex-col gap-6 max-w-2xl text-left">
              <h2 className="text-[#1A1A1A] text-4xl sm:text-5xl lg:text-[54px] font-bold leading-[1.1] tracking-tight">
                Our Impact in Numbers
              </h2>
              <p className="text-[#6B6B6B] text-lg sm:text-xl leading-relaxed">
      ...
      <section className="bg-[rgba(255,239,247,1)] flex items-center justify-center px-4 sm:px-6 lg:px-24 border-t border-gray-100">
        <div className="w-full max-w-[1440px] py-20 lg:py-32">
          <div className="flex flex-col gap-16">
            {/* Header */}
            <div className="flex flex-col gap-4 items-center text-center max-w-3xl mx-auto">
              <h2 className="text-[#1A1A1A] text-[36px] sm:text-[44px] font-bold leading-[1.2] tracking-tight">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {testimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className="flex flex-col justify-between gap-10 p-8 lg:p-12 rounded-[32px] bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300"
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-full bg-gray-100 border border-gray-200 flex-shrink-0"></div>
