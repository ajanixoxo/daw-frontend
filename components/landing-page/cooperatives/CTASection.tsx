      ...
      >
        <div className="relative overflow-hidden rounded-[32px] bg-[#F10E7C] px-6 sm:px-12 lg:px-20 py-12 sm:py-16 lg:py-[107px]">
          ...
          <div className="relative z-10 flex flex-col gap-8 sm:gap-10 max-w-[500px]">
            <div className="flex flex-col gap-4">
              <motion.h2
                ...
                className="text-[#FFFFFF] text-3xl sm:text-4xl lg:text-[52px] font-bold leading-[120%] tracking-[-3.12px]"
              >
                Ready to Transform Your Business?
              </motion.h2>
              <motion.p
                variants={fadeIn("up", 0.2)}
                className="text-[#FFFFFF] text-base sm:text-lg lg:text-xl font-normal leading-[140%] tracking-[-0.8px]"
              >
                Join thousands of entrepreneurs who are already growing their
            ...
            <motion.div variants={fadeIn("up", 0.3)}>
              <Link href="/cooperative/cooperative-signup">
                <button className="flex px-10 py-5 justify-center items-center gap-1 rounded-[40px] bg-[#FFFFFF] hover:bg-[#f5f5f5] text-[#F10E7C] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 self-start font-bold text-lg">
          ...
          <motion.div
            ...
            className="absolute right-[-10%] top-1/2 -translate-y-1/2 w-[500px] h-[500px] hidden lg:block opacity-50"
          >
            <svg
              width="500"
              height="500"
