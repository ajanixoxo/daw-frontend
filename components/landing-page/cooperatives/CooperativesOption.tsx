  ...
  const cooperatives = [
    {
      id: 1,
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/259bcb3bbd7d9c4442c1d6e65a66f62082673945?width=818",
      verified: true,
    ...
    },
    {
      id: 2,
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/4fdf8c55a11884ac6b602297ba3995f9688a619b?width=818",
      verified: true,
      tags: ["Fashion", "Textiles", "Accessories"],
      title: "Lagos Fashion Collective",
      description:
        ...
        <div className="flex flex-col gap-12 sm:gap-14 lg:gap-[60px]">
          ...
          >
            ...
            <p className="text-[#6B6B6B] text-sm sm:text-base font-normal leading-[140%] tracking-[-0.64px] max-w-[516px]">
              Access expert-led courses tailored to help entrepreneurs succeed
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row justify-between items-stretch sm:items-start gap-4 sm:gap-6"
          >
            {/* Category Dropdown */}
            <button className="flex h-[60px] px-6 sm:px-8 justify-center items-center gap-4 rounded-[40px] border border-[#E5E5E5] bg-[#FFFFFF] hover:border-[#F10E7C] transition-colors">
            ...
            {/* Search Bar */}
            <div className="flex flex-1 sm:max-w-[624px] h-[60px] px-5 items-center gap-1 rounded-[40px] border border-[#E5E5E5] bg-[#F5F5F5] focus-within:border-[#F10E7C] transition-colors">
              <input
                type="text"
          ...
          <div className="flex flex-col gap-12 sm:gap-14 lg:gap-[60px]">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-[30px]">
              {cooperatives.map((coop, index) => (
                <motion.div
                  ...
                  className="flex flex-col gap-5 rounded-[20px] group cursor-pointer"
                >
                  {/* Image */}
                  <div className="relative w-full h-[300px] overflow-hidden rounded-[20px]">
                    ...
                    />
                    {coop.verified && (
                      <div className="absolute top-[18px] right-[18px] inline-flex px-3 py-1 items-start rounded-[12px] bg-[#E3FDE7] z-10">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      <h3 className="text-[#222222] text-base font-bold leading-[120%] tracking-[-0.96px] group-hover:text-[#F10E7C] transition-colors">
                        {coop.title}
                      </h3>
                    ...
                    <Link href="/cooperative/cooperative-signup">
                      <button className="flex w-full px-5 py-3 justify-center items-center gap-2 rounded-[40px] bg-[#222222] hover:bg-[#000000] text-white transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
                        <svg
                          width="20"
                          height="20"
                          viewBox="0 0 20 20"
                        ...
                        <span className="text-base font-medium tracking-[-0.64px]">
            ...
            >
              <button className="flex px-6 sm:px-8 py-4 justify-center items-center gap-1 rounded-[40px] bg-[#F10E7C] hover:bg-[#d00c69] text-white transition-all shadow-md hover:shadow-lg hover:-translate-y-1">
                <span className="text-lg sm:text-xl font-medium tracking-[-0.8px]">
                  View more
                </span>
              </button>
            </motion.div>
