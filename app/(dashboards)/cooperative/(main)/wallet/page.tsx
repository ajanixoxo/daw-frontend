...
import { WalletStats } from "@/components/(dashboards)/cooperative-dashboard/wallet/wallet-stats";
import { RecentTransactionsTable } from "@/components/(dashboards)/cooperative-dashboard/wallet/recent-transactions-table";
import { WithdrawFundsDrawer } from "@/components/(dashboards)/cooperative-dashboard/wallet/withdraw-funds-drawer";
import { WalletSetup } from "@/components/(dashboards)/cooperative-dashboard/wallet/wallet-setup";
...
export default function CooperativeWalletPage() {
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-[#667185] mt-1">
                            Create a virtual account for your cooperative to manage funds
                        </p>
                    </div>
                    {account?.accountNo && (
    ...
    return (
        <div className="p-6 max-w-[1600px] mx-auto space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-[#1d1d2a]">Cooperative Wallet</h1>
                    <div className="flex items-center gap-2 mt-1">
                        <p className="text-sm text-[#667185]">
                            Manage contributions, loans, and payouts
                        </p>
                        <Button
                            variant="ghost"
                            size="icon"
